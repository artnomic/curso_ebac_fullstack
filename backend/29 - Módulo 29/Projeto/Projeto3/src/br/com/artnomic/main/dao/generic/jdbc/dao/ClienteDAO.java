...
import br.com.artnomic.main.dao.generic.jdbc.ConnectionFactory;
...
public class ClienteDAO implements IClienteDAO {
    ...
    public Integer excluir(Cliente cliente) throws Exception {
        ...
        try {
            ...
            stm = connection.prepareStatement(sql);
            adicionarParametrosDelect(stm, cliente);
            return stm.executeUpdate();
        } catch (Exception e) {
            throw e;
        } finally {
    ...
    private void adicionarParametrosDelect(PreparedStatement stm, Cliente cliente) throws SQLException {
        stm.setString(1, cliente.getCodigo());
    }
